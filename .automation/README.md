...
- `VALIDATION_CANDIDATE.json` is a temporary source attestation for the chapter under production. It is intentionally ignored by Git and is never a publication record.
